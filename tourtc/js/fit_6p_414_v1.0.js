var htmlInit = {
    ...
    SetFont: function() {
        ...
        $("html").css("font-size", $(window).width() / 4.14);
    }
}
...
window.addEventListener("onorientationchange" in window ? "orientationchange" : "resize", function () {
    ...
    var html = '<div class="vspromps" id="vspromps" style="display:none"><div class="mask-box"><div class="mask-pic"><i></i></div><span>为了更好的体验，请将手机/平板竖过来</span></div></div>';
    var vsprompsDom = document.createElement("div");
    vsprompsDom.className = "vspromps";
    vsprompsDom.id = "vspromps";
    vsprompsDom.innerHTML = '<div class="vspromps-box"><div class="vspromps-pic"><i></i></div><span>为了更好的体验，请将手机/平板竖过来</span></div>';
    document.getElementsByTagName("body")[0].appendChild(vsprompsDom);
